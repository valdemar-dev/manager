  ...
  return (
    <main className="min-h-screen mx-auto overflow-hidden sm:max-w-xl md:max-w-3xl lg:max-w-5xl text-text p-4 pt-12 box-border">
      ...
      <div className="flex flex-row gap-2">
        <button className="bg-accent text-primary active:bg-secondary-darker sm:hover:bg-secondary transition-all duration-200 font-semibold text-lg px-5 py-2 rounded-md fadeIn animation-delay-800" ><a href="/user/register">Register</a></button>
        <button className="bg-secondary active:bg-secondary-darker sm:hover:bg-secondary transition-all duration-200 font-semibold text-lg px-5 py-2 rounded-md fadeIn animation-delay-900" ><a href="/user/login">Login</a></button>
      </div>
