  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-2 gap-10">
        ...
        >
          ...
          <Link href="/vault/" className="mt-2 flex gap-1 items-center font-semibold">
            ...
            <g clipPath="url(#clip0_429_11072)">
              <path d="M11 3.99994H4V17.9999C4 19.1045 4.89543 19.9999 6 19.9999H18C19.1046 19.9999 20 19.1045 20 17.9999V12.9999" stroke="var(--primary-text)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M9 14.9999L20 3.99994" stroke="var(--primary-text)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M15 3.99994H20V8.99994" stroke="var(--primary-text" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
            </g>
          </svg>  
          </Link>
        </Card>
        ...
        >
          <p>
            Take private, or public notes whenever, wherever. 
